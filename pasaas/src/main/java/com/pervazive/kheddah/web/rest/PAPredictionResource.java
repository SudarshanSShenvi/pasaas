...
public class PAPredictionResource {
    ...
    public ResponseEntity<List<PAPrediction>> getAllPAPredictions(@ApiParam Pageable pageable, HttpServletRequest request)
        ...
        Page<PAPrediction> page = pAPredictionService.findAll(pageable, paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
