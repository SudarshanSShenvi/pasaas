...
public class PAReliabilityConfResource {
    ...
    public ResponseEntity<List<PAReliabilityConf>> getAllPAReliabilityConfs(@ApiParam Pageable pageable, HttpServletRequest request)
        ...
        Page<PAReliabilityConf> page = pAReliabilityConfService.findAll(pageable,  paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
