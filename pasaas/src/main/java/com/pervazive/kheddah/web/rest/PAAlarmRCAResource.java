...
public class PAAlarmRCAResource {
    ...
    public ResponseEntity<List<PAAlarmRCA>> getAllPAAlarmRCAS(@ApiParam Pageable pageable, HttpServletRequest request)
        ...
        */
        Page<PAAlarmRCA> page = pAAlarmRCAService.findAll(pageable, paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
