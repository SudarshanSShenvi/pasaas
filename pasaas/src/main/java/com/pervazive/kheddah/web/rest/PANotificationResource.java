...
public class PANotificationResource {
    ...
    public ResponseEntity<List<PANotification>> getAllPANotifications(@ApiParam Pageable pageable, HttpServletRequest request)
       ...
       /* if(CurrentOrganization.getCurrentOrganization() == null) 
        ...
        Page<PANotification> page = pANotificationService.findAll(pageable, paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
