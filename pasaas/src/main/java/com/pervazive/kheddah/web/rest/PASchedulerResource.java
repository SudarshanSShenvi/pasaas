...
public class PASchedulerResource {
    ...
    public ResponseEntity<List<PAScheduler>> getAllPASchedulers(@ApiParam Pageable pageable, HttpServletRequest request)
        ...
        Page<PAScheduler> page = pASchedulerService.findAll(pageable, paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
