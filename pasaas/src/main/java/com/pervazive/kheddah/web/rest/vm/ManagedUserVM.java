package com.pervazive.kheddah.web.rest.vm;
...
public class ManagedUserVM extends UserDTO {
    ...
    public ManagedUserVM(Long id, String login, String password, String firstName, String lastName, String defaultOrganization,
        ...
        super(login, firstName, lastName, defaultOrganization, email, activated, langKey, authorities, organizations, projects, image, imageContentType);
        this.id = id;
