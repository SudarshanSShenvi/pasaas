...
public class PAErrorMessageResource {
    ...
    public ResponseEntity<List<PAErrorMessage>> getAllPAErrorMessages(@ApiParam Pageable pageable)
        ...
        Page<PAErrorMessage> page = pAErrorMessageService.findAll(pageable, paOrganizationService.findOrganizationByName(CurrentOrganization.getCurrentOrganization()) );
