...
public class PAReliabilityScoreResource {
    ...
    @Timed
    public ResponseEntity<List<PAReliabilityScore>> getAllPAReliabilityScores(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of PAReliabilityScores");
        Page<PAReliabilityScore> page = pAReliabilityScoreService.findAll(pageable);
