...
public class PARawAlarmDataResource {
    ...
    public ResponseEntity<List<PARawAlarmData>> getAllPARawAlarmData(@ApiParam Pageable pageable, HttpServletRequest request)
       ...
       /* if(CurrentOrganization.getCurrentOrganization() == null) 
        ...
        Page<PARawAlarmData> page = pARawAlarmDataService.findAll(pageable,  paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
