...
public class PARawAlarmDataResource {
    ...
    @Timed
    public ResponseEntity<List<PARawAlarmData>> getAllPARawAlarmData(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of PARawAlarmData");
        Page<PARawAlarmData> page = pARawAlarmDataService.findAll(pageable);
