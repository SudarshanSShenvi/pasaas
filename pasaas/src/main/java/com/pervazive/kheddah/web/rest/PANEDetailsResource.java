...
public class PANEDetailsResource {
    ...
    public ResponseEntity<List<PANEDetails>> getAllPANEDetails(@ApiParam Pageable pageable, HttpServletRequest request)
        ...
        Page<PANEDetails> page = pANEDetailsService.findAll(pageable, paOrganizationService.findOrganizationByName(((PAOrganization) request.getSession().getAttribute("s_organization")).getOrganization()));
