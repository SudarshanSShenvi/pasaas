...
public class PASchedulerIntervalResource {
    ...
    @Timed
    public ResponseEntity<List<PASchedulerInterval>> getAllPASchedulerIntervals(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of PASchedulerIntervals");
        Page<PASchedulerInterval> page = pASchedulerIntervalService.findAll(pageable);
