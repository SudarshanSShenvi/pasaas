    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'Pervazive | Pervazive Inc';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'Pervazive | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
function minimalizaSidebar($timeout) {
    return {
        ...
        controller: "mini_controller"
    };
};
function mini_controller($scope, $element, $timeout) {
...
/**
 * icheckguru - Directive for custom checkbox icheck
 */
function icheckguru($timeout) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function($scope, element, $attrs, ngModel) {
                    ...
                    radioClass: 'iradio_square-green'
                        ...
                        if ($(element).attr('type') === 'checkbox' && $attrs['ngModel']) {
                            ...
                            $scope.$apply(function() {
                                ...
                                angular.forEach($scope.array_for_icheckguru, function (item) {
...
angular
    ...
    .directive('icheckguru', icheckguru)
    .directive('ionRangeSlider', ionRangeSlider)
    .directive('dropZone', dropZone)
    .directive('fancyBox', fancyBox)
    .directive('responsiveVideo', responsiveVideo)

    // minimalizaSidebar.$inject = ['$scope', '$http', '$filter'];
    .directive('minimalizaSidebar', ['$timeout', minimalizaSidebar])
    .controller('mini_controller', ['$scope', '$element', '$timeout', mini_controller])
    ;
