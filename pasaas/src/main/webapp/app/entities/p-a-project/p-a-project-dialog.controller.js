...
*/
		...
		vm.move_participants = function(from_array, to_array, coming_user){
			...
			if(!checkAvailability(to_array, coming_user)){
		...
		function save () {
			...
			if (vm.pAProject.id !== null) {
				PAProject.update(vm.pAProject, onSaveSuccess1, onSaveError);
			} else {
				PAProject.save(vm.pAProject, onSaveSuccess2, onSaveError);
			}
		}
		...
		function onSaveSuccess1 (result) {
            ...
            vm.isSaving = false;
            if(vm.previousState === 'p-a-project.su'){
